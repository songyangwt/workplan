...
$("tr.btbj:even").css({"background-color":"#bfd3fc","font-family": "黑体","font-size": "14px","font-weight":"lighter" }); 
 ...
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <form  action="<%=path%>/showleavedata.action"  method="post" name="fm1">
					<table height="80" align="center" cellpadding="0"
						cellspacing="2" border:0px;"  >
						<tr>
							<td
								style="color: #1778C2; padding-top: 0px; padding-bottom: 5px; border: 0px; font-size: 26px; font-family: '黑体';"
								colspan="13" align="center" bordercolor="#FFFFFF"><b>休假人员明细信息 </b>
							</td>
						</tr>
						<tr>
						...
						<tr height="50px" class="表格表头背景1" id="hang">
						  ...
						  <td  width="130px" align="center" valign="middle" nowrap
							...
							<td  width="70px" height="25" align="center" valign="middle" nowrap><div
								...
								<td width="130px" height="25" align="center" valign="middle" nowrap><div
										align="center">${fb:newnumbertozu(wc.newnumber)}</div></td>
								<td width="100px" height="25" align="center" valign="middle" nowrap><div
										align="center">${fb:leavetypetostring(wc.leavetype)}</div></td>
							...
							<td colspan="9">
								<div align="center">
								<a	href="<%=path%>/showleavedata.action?zhuan=1&name=${strtemp}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/showleavedata.action?zhuan=1&name=${strtemp}&currentPage=${nextPage}"
