					...
					<table height="80" align="center" cellpadding="0"
						...
						<tr>
							<td
								...
								colspan="13" align="center" bordercolor="#FFFFFF"><b> 待审批事项 </b>
							</td>
						</tr>
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<td colspan="13">
								<div align="center">
								<a	href="<%=path%>/showshenpidata.action?newnumber=${newnumber}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/showshenpidata.action?newnumber=${newnumber}&currentPage=${nextPage}"
